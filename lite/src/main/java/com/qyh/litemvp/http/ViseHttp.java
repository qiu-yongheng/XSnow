...
import com.qyh.litemvp.http.request.DeleteRequest;
import com.qyh.litemvp.http.request.DownloadRequest;
import com.qyh.litemvp.http.request.GetRequest;
import com.qyh.litemvp.http.request.HeadRequest;
import com.qyh.litemvp.http.request.OptionsRequest;
import com.qyh.litemvp.http.request.PatchRequest;
import com.qyh.litemvp.http.request.PostRequest;
import com.qyh.litemvp.http.request.PutRequest;
import com.qyh.litemvp.http.request.RetrofitRequest;
import com.qyh.litemvp.http.request.UploadRequest;
...
public class ViseHttp {
    ...
    private static ApiCache apiCache;// 磁盘缓存
